...
public class Strings {
    public static final String SERVER_LISTEN = "Server Is listening to port : ";
    public static final String NEW_CLIENT = "New Client Connected";
    public static final String SERVER_CONFIG_FILE = "Config File not Found";
    ...
    public static final String ATTR_STR_SERVER = "server";
    public static final String ATTR_STR_PORT = "port";
